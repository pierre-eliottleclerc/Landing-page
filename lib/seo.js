...
const META = {
  accueil: {
    fr: {
      title: 'Florestan IM — Private Equity européen & fonds de continuation',
      description:
    ...
    en: {
      title: 'Florestan IM — European Private Equity & Continuation Funds',
      description:
  ...
  strategie: {
    fr: {
      title: 'Notre stratégie — Fonds de continuation single asset | Florestan IM',
      description:
    ...
    en: {
      title: 'Our Strategy — Single-Asset Continuation Funds | Florestan IM',
      description:
  ...
  fc1: {
    fr: {
      title: 'Florestan Continuity 1 (FC1) — FPCI fonds de continuation | Florestan IM',
      description:
    ...
    en: {
      title: 'Florestan Continuity 1 (FC1) — Continuation Fund | Florestan IM',
      description:
  ...
  fc2: {
    fr: {
      title: "Florestan Continuity 2 (FC2) — FPCI en cours d'investissement | Florestan IM",
      description:
    ...
    en: {
      title: 'Florestan Continuity 2 (FC2) — Currently Investing | Florestan IM',
      description:
  ...
  equipe: {
    fr: {
      title: 'Notre équipe | Florestan IM',
      description:
  ...
  actualites: {
    fr: {
      title: 'Actualités | Florestan IM',
      description:
        'Les dernières nouvelles de Florestan IM : opérations réalisées, fonds de continuation et sociétés en portefeuille.',
    },
    en: {
      title: 'News | Florestan IM',
      description:
        'The latest from Florestan IM: completed transactions, continuation funds and portfolio companies.',
    },
  },
  contact: {
    fr: {
      title: 'Contact | Florestan IM',
      description:
        "Échangeons sur votre allocation en Private Equity. Florestan IM — 250bis rue du Faubourg Saint-Honoré, 75008 Paris.",
    },
    en: {
      title: 'Contact | Florestan IM',
      description:
        "Let's discuss your private equity allocation. Florestan IM — 250bis rue du Faubourg Saint-Honoré, 75008 Paris.",
    },
  },
  espace: {
    fr: {
      title: 'Espace investisseurs | Florestan IM',
      description: 'Accès sécurisé aux documents mis à disposition des investisseurs de Florestan IM.',
    },
    en: {
      title: 'Investor Portal | Florestan IM',
      description: 'Secure access to documents made available to Florestan IM investors.',
    },
  },
  mentions: {
    fr: {
      title: 'Mentions légales | Florestan IM',
      description:
        "Mentions légales de Florestan IM : identification de la société, coordonnées, hébergement et informations réglementaires (ORIAS 24007087).",
    },
    en: {
      title: 'Legal Notice | Florestan IM',
      description:
        'Legal notice for Florestan IM: company identification, contact details, hosting and regulatory information (ORIAS 24007087).',
    },
  },
  confidentialite: {
    fr: {
      title: 'Politique de confidentialité | Florestan IM',
      description:
        'Comment Florestan IM collecte, utilise et protège vos données personnelles, conformément au RGPD.',
    },
    en: {
      title: 'Privacy Policy | Florestan IM',
      description:
        'How Florestan IM collects, uses and protects your personal data, in accordance with the GDPR.',
    },
  },
  avertissement: {
    fr: {
      title: 'Avertissement | Florestan IM',
      description:
